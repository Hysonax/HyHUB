...
local LibName = tostring(math.random(1, 100))..tostring("HyHUB")..tostring(math.random(1, 100))

function HyLibrary:CloseOpen()
...
function HyLibrary:Destroy()
    game.CoreGui[LibName]:Destroy()
end

function HyLibrary:Create()
    local HyLib = Instance.new("ScreenGui")
    ...
    local Hy = Instance.new("TextLabel")
    local HUB = Instance.new("TextLabel")


    HyLib.Name = tostring(LibName)
    HyLib.Parent = game.CoreGui
    HyLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    Library.Name = "Library"
    Library.Parent = HyLib
    ...
    CurrentContainer.Parent = allItems
        ...
        Hy.Name = "Hy"
        Hy.Parent = Library
        Hy.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        Hy.BackgroundTransparency = 1.000
        Hy.BorderColor3 = Color3.fromRGB(27, 42, 53)
        Hy.Position = UDim2.new(0.0100864554, 0, 0.0205479451, 0)
        Hy.Size = UDim2.new(0, 42, 0, 28)
        Hy.Font = Enum.Font.GothamBold
        Hy.Text = "Hy"
        Hy.TextColor3 = Color3.fromRGB(108, 108, 108)
        Hy.TextSize = 20.000
        Hy.TextWrapped = true
        Hy.TextXAlignment = Enum.TextXAlignment.Left
        ...
        HUB.Position = UDim2.new(0.0506051886, 0, 0.0205479451, 0)
